...
function menu:Create(parent)
  ...
  buttonPane:AddButton("Back", function() addon.MainMenu:Show("demo") end, { anchor = "LEFT" })
  buttonPane:AddButton("Accept", nil, { anchor = "RIGHT" })
  buttonPane:AddButton("Copy to Drafts", nil, { anchor = "RIGHT" })
  ...
  scrollingEditBox.editBox:SetText(loremipsum)
...
function menu:OnShow(frame)
  frame.scrollingEditBox.editBox:HighlightText(0, 0)
  frame.scrollingEditBox.editBox:ClearFocus()
end
