--[[
  For All Indents And Purposes, modified for YAML
  Modifications by Jacob Brogan
--]]
...
local MAJOR, MINOR = "IndentationLibYaml", 1
local IndentationLib, oldminor = LibStub:NewLibrary(MAJOR, MINOR)
